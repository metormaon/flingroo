package il.ac.technion.cs.flingroo.ebnf.grammar

import il.ac.technion.cs.flingroo.ebnf.EBNF
import il.ac.technion.cs.flingroo.ebnf.element.Variable
import static il.ac.technion.cs.flingroo.ebnf.grammar.JavaEbnf.V.*
...
class JavaEbnf {
    ...
    static void main(String[] args) {
        EBNF java = ebnf {
            ...
            TypeIdentifier >> Identifier //but not var or yield
